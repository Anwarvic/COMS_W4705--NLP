...
if __name__ == "__main__": 
    counter = Hmm(3)
    #USE THIS WITH P1 & P2:
    counter.train(file("data/gene.train","r"), RARE=True)
    with open("outputs/p1_count.txt", "w") as f:
        counter.write_counts(f)

    #USE THIS WITH P3 ONLY:
    counter.train(file("data/gene.train","r"), GROUP=True)
    with open("outputs/p3_count.txt", "w") as f:
        counter.write_counts(f)
